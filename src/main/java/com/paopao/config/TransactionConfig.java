...
public class TransactionConfig {
    private static final String ALL = "execution (* com.paopao..*(..))";
    private static final String CONTROLLER = "execution(* com.paopao.controller..*(..))";
    private static final String SERVICE = "execution (* com.paopao.service..*(..))";
    private static final String DAO = "execution (* com.paopao.dao..*(..))";
    private static final String MAPPER = "execution (* com.paopao.mapper..*(..))";
    private static final String CACHE = "execution (* com.paopao.cache..*(..))";
