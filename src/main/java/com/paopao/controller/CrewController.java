...
import com.paopao.async.asyncRunner.SaveFileRunner;
...
import com.paopao.model.modelView.CrewResponse;
import com.paopao.model.modelView.RequestModel.CrewRequest;
...
import com.paopao.util.Base64Util;
...
public class CrewController {
    ...
    public CrewResponse register(@RequestBody Crew crew) throws GlobalException {
        MyHttpStatus status = MyHttpStatus.OK;
    ...
    public CrewResponse getCrew(@RequestBody Crew crew) throws GlobalException {
        MyHttpStatus status = MyHttpStatus.OK;
    ...
    public CrewResponse recommendUser(@RequestBody CrewRequest crewRequest) throws GlobalException {
        MyHttpStatus status = MyHttpStatus.OK;
    ...
    public CrewResponse update(@RequestBody Crew crew) throws GlobalException {
        MyHttpStatus status = MyHttpStatus.OK;
    ...
    public CrewResponse passwordReset(@RequestBody CrewRequest crewRequest) throws GlobalException {
        MyHttpStatus status = MyHttpStatus.OK;
    ...
    public CrewResponse uploadAvatar(@RequestBody CrewRequest crewRequest) throws GlobalException {
        MyHttpStatus status = MyHttpStatus.OK;
        ...
        Base64Util imgMeta = new Base64Util(base64);
